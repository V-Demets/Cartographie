...
# file_Perim <- "/Users/Valentin/Foret/Travail/Leforestier/Geneve/Prive_Geneve/Out/SIG/Vecteurs/Perimetres/Test_Coord.shp"
file_Perim <- file.choose()
...
shp3 <- spTransform(shp_Perim, CRS("+init=epsg:3857"))
writeOGR(shp3,
...
file_PerimPlac <- "/Users/Valentin/Foret/Travail/Leforestier/Geneve/FD_Geneve/Data/SIG/Vecteurs/Perimetres/Foret_Privee/PerimPlacPRIV_Buffer25m_L93.shp" # Ce shape provient du shape
# Perm_GenevePlaPRIV_L93.shp auquel on a enlevé un shape de 25m (Buffer25m_L93.shp) puis auquel 
# on a rajouté les zones de contact entreles polygones lorsqu'on rajoutait 4m au buffer (~routes).
